# This Makefile is for the XML::XPathScript extension to perl.
#
...
#	ABSTRACT_FROM => q[XPathScript.pm]
#	AUTHOR => q[Dominique Quatravaux <dom@ideax.com> and Yanick Champoux <yanick@babyl.dyndns.org>]
#	EXE_FILES => [q[script/xpathscript]]
#	NAME => q[XML::XPathScript]
#	VERSION_FROM => q[XPathScript.pm]
...
HTMLLIBPODS    = 
HTMLSCRIPTPODS = 
MAN1PODS = script/xpathscript
MAN3PODS = XPathScript.pm \
	lib/Apache/AxKit/Language/YPathScript.pm
HTMLEXT = html
...
TO_INST_PM = XPathScript.pm \
	lib/Apache/AxKit/Language/YPathScript.pm \
	lib/XML/XPathScript/Toys.pm

PM_TO_BLIB = XPathScript.pm \
	$(INST_LIBDIR)/XPathScript.pm \
	lib/XML/XPathScript/Toys.pm \
	$(INST_LIB)/XML/XPathScript/Toys.pm \
	lib/Apache/AxKit/Language/YPathScript.pm \
	$(INST_LIB)/Apache/AxKit/Language/YPathScript.pm
...
manifypods : pure_all script/xpathscript \
	XPathScript.pm \
	lib/Apache/AxKit/Language/YPathScript.pm
	@$(POD2MAN) \
	script/xpathscript \
	$(INST_MAN1DIR)/xpathscript.$(MAN1EXT) \
	XPathScript.pm \
	$(INST_MAN3DIR)/XML::XPathScript.$(MAN3EXT) \
	lib/Apache/AxKit/Language/YPathScript.pm \
	$(INST_MAN3DIR)/Apache::AxKit::Language::YPathScript.$(MAN3EXT)
...
EXE_FILES = script/xpathscript

FIXIN = $(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::MakeMaker \
    -e "MY->fixin(shift)"

pure_all :: $(INST_SCRIPT)/xpathscript
	@$(NOOP)

realclean ::
	rm -f $(INST_SCRIPT)/xpathscript

$(INST_SCRIPT)/xpathscript: script/xpathscript Makefile $(INST_SCRIPT)/.exists
	@rm -f $(INST_SCRIPT)/xpathscript
	cp script/xpathscript $(INST_SCRIPT)/xpathscript
	$(FIXIN) $(INST_SCRIPT)/xpathscript
	-@$(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/xpathscript
...
realclean purge ::  clean
	...
	rm -f  $(INST_LIBDIR)/XPathScript.pm $(INST_LIB)/XML/XPathScript/Toys.pm
	rm -f $(INST_LIB)/Apache/AxKit/Language/YPathScript.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"XML-XPathScript\" VERSION=\"0,12,0,0\">\n}. qq{\t<TITLE>XML-XPathScript</TITLE>\n}. qq{\t<ABSTRACT>a Perl framework for XML stylesheets</ABSTRACT>\n}. qq{\t<AUTHOR>Dominique Quatravaux &lt;dom\@ideax.com&gt; and Yanick Champoux &lt;yanick\@babyl.dyndns.org&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > XML-XPathScript.ppd
